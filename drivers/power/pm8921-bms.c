...
static const struct batt_info_map batt_info_map[] = {
    ...
    {"HB4742A0RBW_LG",  &Huawei_HB4742A0RBW_LG_data,    4350},
    {"HB4742A0RBW_SNY",  &Huawei_HB4742A0RBW_SNY_data,    4350},
};
...
======================================================================================*/
int get_avarage_vbat_uv(struct pm8921_bms_chip *chip,int sample_count)
{
	...
	{
		rc = get_battery_uvolts(chip,&vbat_uv);
		if(rc)
		{
...
int hw_protect_voltage_check(struct pm8921_bms_chip *chip,int soc,int sample_count)
{
	int vbat_uv = 0;
...
#ifdef CONFIG_HUAWEI_KERNEL
	chip->report_ocv_uv = ocv_est_uv;
	chip->last_rbatt = rbatt;
#endif
...
/*============================================================================================
FUNCTION        pm8921_bms_get_ocv_uv

DESCRIPTION    This function is called for gettng ocv_uv
...
=============================================================================================*/
int pm8921_bms_get_ocv_uv(void)
{
	int ibat_ua = 0, vbat_uv = 0;
	int rc = 0;
	...
	if (rc < 0) {
		pr_err("simultaneous vbat ibat failed err = %d\n", rc);
		return	the_chip->report_ocv_uv;
	}

	the_chip->report_ocv_uv  = vbat_uv + (ibat_ua * the_chip->last_rbatt)/UV_PER_MV;
