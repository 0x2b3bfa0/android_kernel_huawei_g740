                    ...
                    const char *buf, size_t size)
{
    ...
    {
        /* factory mode, normal mode, google mode, slate test mode, authentication mode, rmnet mode
        ...
        if (pid_index != ORI_INDEX && pid_index != CDROM_INDEX && pid_index != GOOGLE_INDEX
            && pid_index != SLATE_TEST_INDEX && pid_index != AUTH_INDEX && pid_index != RMNET_INDEX)
        {
