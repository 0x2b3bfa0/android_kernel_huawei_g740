...
static inline bool can_support_rndis(struct usb_configuration *c)
{
    ...
    /* us/sprintmvno does not want to support rndis*/
    else if(!strcmp(usb_para_data.vender_para.country_name, COUNTRY_US)
        && !strcmp(usb_para_data.vender_para.vender_name, VENDOR_SPRINT))
    {
        printk("%s: us/sprintmvno product, rndis not supported\n", __func__);
        return false;
    }
    else
    {
