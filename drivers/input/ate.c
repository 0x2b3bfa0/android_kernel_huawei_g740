...
#define BUF_NAME_SIZE (2 * IE_SIZE)
static int inputevent_data_save(void)
{
    char buf[IE_SIZE]={0};
    char buf_name[BUF_NAME_SIZE]={0};
    ...
    set_fs(KERNEL_DS);
    pos = 0;
    /* clear warnings and errors for coverity*/
	...
	struct device_attribute *attr, const char *buf, size_t count)
{
    ...
    /* clear warnings and errors for coverity*/
    ret = snprintf(ate_dt->iedt_file_dir, MAX_FILE_DIR_NAME, "%s", buf);
...
static void default_set_input_device_filter_array(void )
{
    /* clear warnings and errors for coverity*/
#if defined MSM_8960_PLATFORM
    strncpy(ate_dt->idf.dev_name[0], "synaptics", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[0][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[0] = TOUCH_EVENT;
    strncpy(ate_dt->idf.dev_name[1], "qt1060", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[1][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[1] = TOUCH_BUTTON_EVENT;
    strncpy(ate_dt->idf.dev_name[2], "pmic8xxx_pwrkey", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[2][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[2] = POWER_KEY_EVENT;
    strncpy(ate_dt->idf.dev_name[3], "gpio-keys", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[3][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[3] = SOUND_KEY_EVENT;
    ate_dt->idf.filer_total = SOUND_KEY_EVENT+1;
#elif defined TI_OMAP_PLATFORM
    strncpy(ate_dt->idf.dev_name[0], "atmel-touchscreen", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[0][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[0] = TOUCH_EVENT;
    strncpy(ate_dt->idf.dev_name[1], "qt1060", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[1][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[1] = TOUCH_BUTTON_EVENT;
    strncpy(ate_dt->idf.dev_name[2], "twl6030_pwrbutton", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[2][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[2] = POWER_KEY_EVENT;
    strncpy(ate_dt->idf.dev_name[3], "huawei_keypad", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[3][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[3] = SOUND_KEY_EVENT;
    ate_dt->idf.filer_total = SOUND_KEY_EVENT+1;
    ...
    ate_dt->idf.dev_name[1][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[1] = TOUCH_BUTTON_EVENT;
    strncpy(ate_dt->idf.dev_name[2], "k3v2_power_key", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[2][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[2] = POWER_KEY_EVENT;
    strncpy(ate_dt->idf.dev_name[3], "k3v2_gpio_key", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[3][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[3] = SOUND_KEY_EVENT;
    ate_dt->idf.filer_total = SOUND_KEY_EVENT+1;
#else
    ...
    ate_dt->idf.dev_name[1][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[1] = TOUCH_BUTTON_EVENT;
    strncpy(ate_dt->idf.dev_name[2], "7k_handset", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[2][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[2] = POWER_KEY_EVENT;
    strncpy(ate_dt->idf.dev_name[3], "default_keypad", MAX_SIZE_OF_DEV_NAME);
    ate_dt->idf.dev_name[3][MAX_SIZE_OF_DEV_NAME - 1] = '\0';
    ate_dt->idf.input_event_type[3] = SOUND_KEY_EVENT;
    ate_dt->idf.filer_total = SOUND_KEY_EVENT+1;
#endif
...
static int __init ate_init(void)
{
    ...
    ate_dt->iedt_file_dir[MAX_FILE_DIR_NAME - 1] = '\0';
